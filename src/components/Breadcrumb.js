...
const routeConfig = {
  ...
  '/continuation-management': { name: '継続管理', icon: null },
  ...
  '/account-sales-dashboard': { name: 'アカウント営業ダッシュボード', icon: null },
  '/account-deals-list': { name: 'アカウント営業 案件一覧', icon: null },
  '/key-accounts': { name: '対象企業リスト', icon: null },
